...
#   define TRACE_FIELD_GM(BLOCK,NAME,FIELD,SCALE,gx,gy,gz,mx,my,mz,PLOT) \
  {                                                                     \
    double sum_all=0.0;                                                 \
    double sum_real=0.0;                                                \
    double sum_abs=0.0;                                                 \
    ...
    CkPrintf ("DEBUG_FIELD (%g) [%g] | (%g : %g %g %g) %s\n",     \
              sum_real,sum_all,                                         \
    ...
    fflush(stdout);                                                     \
    char filename[80];                                                  \
    snprintf (filename,sizeof(filename),"renzo-e-%s-%s.png",NAME,BLOCK->name().c_str()); \
    png_array (filename,(float*)(FIELD),gx,gy,gz,mx,my,mz,__FILE__,__LINE__,2,16,16,SCALE); \
    snprintf (filename,sizeof(filename),"enzo-e-%s-%s.png",NAME,BLOCK->name().c_str()); \
    png_array (filename,(float*)(FIELD),0,0,0,mx,my,mz,__FILE__,__LINE__,2,16,16,SCALE); \
  }
#   define TRACE_FIELD_(BLOCK,NAME,FIELD,SCALE) TRACE_FIELD_GM(BLOCK,NAME,FIELD,SCALE,gx_,gy_,gz_,mx_,my_,mz_,false)
#   define TRACE_FIELD(BLOCK,NAME,FIELD,SCALE)  TRACE_FIELD_GM(BLOCK,NAME,FIELD,SCALE,gx,gy,gz,mx,my,mz,false)
#   define PRINT_FIELD_(BLOCK,NAME,FIELD,SCALE) TRACE_FIELD_GM(BLOCK,NAME,FIELD,SCALE,gx_,gy_,gz_,mx_,my_,mz_,true)
#   define PRINT_FIELD(BLOCK,NAME,FIELD,SCALE)  TRACE_FIELD_GM(BLOCK,NAME,FIELD,SCALE,gx,gy,gz,mx,my,mz,true)
...
#   define TRACE_FIELD(BLOCK,NAME,FIELD,SCALE) /* ... */
#   define PRINT_FIELD(BLOCK,NAME,FIELD,SCALE) /* ... */
#   define TRACE_FIELD_GM(BLOCK,NAME,FIELD,SCALE,gx,gy,gz,mx,my,mz,PLOT) /* ... */
#   define TRACE_FIELD_(BLOCK,NAME,FIELD,SCALE) /* ... */
#   define TRACE_PARTICLE(ATTRIBUTE,particle,TYPE_NAME,ATTR_NAME) /* ... */
