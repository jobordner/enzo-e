...
public: // interface
  ...
  EnzoPhysicsCosmology(ParameterGroup p)
    : Physics(),
      hubble_constant_now_(p.value("hubble_constant_now",0.701)),
      omega_matter_now_(p.value("omega_matter_now", 0.279)),
      omega_baryon_now_(p.value("omega_baryon_now", 1.0)),
      omega_cdm_now_(p.value("omega_cdm_now", 0.0)),
      omega_lambda_now_(p.value("omega_lambda_now", 0.721)),
      comoving_box_size_(p.value("comoving_box_size", 64.0)),
      max_expansion_rate_(p.value("max_expansion_rate", 0.01)),
      initial_redshift_(p.value("initial_redshift",  20.0)),
      final_redshift_(p.value("final_redshift",-1.0)),
      cosmo_a_(0.0),
      cosmo_dadt_(0.0),
      current_redshift_(-1.0)
  {
